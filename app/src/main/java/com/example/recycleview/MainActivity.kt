...
class MainActivity : AppCompatActivity() {
    ...
    // this is a button that will add a new cat to the recycler view
    ...
    // this is the dialog that will be shown when a cat is clicked
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // this is the swipe to delete functionality
        ...
        // this is the button that will add a new cat to the recycler view
    ...
    // this is the data that we will display in the recycler view
    ...
    // this is the click listener that will be passed to the adapter
}
